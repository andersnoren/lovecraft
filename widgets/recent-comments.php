				...
				if ( $comments ) {
					foreach ( $comments as $comment ) { ?>
						...
						<li>
							...
							<a href="<?php echo get_permalink( $comment->comment_post_ID ); ?>#comment-<?php echo $comment->comment_ID; ?>" title="<?php printf( _x( 'Comment to %s, posted %s', 'Variables: post title, post date', 'lovecraft' ), get_the_title( $comment->comment_post_ID ), get_the_time( get_option( 'date_format' ) ) ); ?>">
