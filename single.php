						...
						<div class="post-navigation-inner">
							...
							if ( ! empty( $prev_post ) ) : ?>
								...
								<div class="post-nav-prev">
									...
									<h4>
										<a href="<?php echo get_permalink( $prev_post->ID ); ?>" title="<?php printf( __( 'Previous post: %s', 'lovecraft' ), esc_attr( get_the_title( $prev_post ) ) ); ?>">
							...
							if (!empty( $next_post )): ?>
								...
								<div class="post-nav-next">					
									...
									<h4>
										<a title="<?php printf( __( 'Next post', 'lovecraft' ), esc_attr( get_the_title( $next_post ) ) ); ?>" href="<?php echo get_permalink( $next_post->ID ); ?>">
